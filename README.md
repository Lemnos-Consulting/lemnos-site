...
<head>
  ...
  <meta name="description" content="Lemnos Consulting walks into fragmented or nonexistent martech stacks and builds them from zero. Deep HubSpot, custom integrations, data architecture, AI-powered workflows. Fractional marketing operations without the enterprise price tag.">
  ...
  <style>
    *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
    ...
    .hero-sub{font-size:1.15rem;color:var(--gray);max-width:660px;line-height:1.8;margin-bottom:3rem}
...
<body>
  ...
  <header class="hero">
    <div class="hero-inner">
      ...
      <p class="hero-sub">Lemnos walks into fragmented or nonexistent martech stacks and stands them up from zero. Deep HubSpot, custom API/webhook/Apps Script integrations, data architecture, AI-powered workflows. Built to last and operated day-to-day, without hiring a full-time ops team.</p>
  ...
  <section id="services" class="fade-in">
    <div class="section-inner">
      ...
      <h2 class="section-title">Seven capabilities. One operator. Built to last.</h2>
      <p class="section-body">Most SMBs don't need 5 agencies. They need one person who can walk into a fragmented stack, build what isn't there, write the custom code where out-of-the-box falls short, and operate it day-to-day. That's what Lemnos does.</p>

      <div class="service-grid">

        <div class="service-card">
          <div class="service-number">01 — Build</div>
          <h3>Building Martech From Scratch</h3>
          <p>Walk into your fragmented or nonexistent stack and stand up the architecture from zero. HubSpot rebuilds across Marketing Hub and Sales Hub — custom properties, deal pipelines, lifecycle stages, governance frameworks. Plus the documentation and operating models that let it survive after I'm gone.</p>
          <div class="service-tools">HubSpot Marketing Hub + Sales Hub · system architecture</div>
        </div>

        <div class="service-card">
          <div class="service-number">02 — Code</div>
          <h3>Custom Integrations &amp; Automation</h3>
          <p>Where out-of-the-box integrations fall short, I write the connection. API integrations, webhooks, custom GTM events, and Apps Script automations to wire HubSpot up to enrichment platforms, ad networks, third-party sales tools, and analytics. The plumbing that makes the rest of the stack work.</p>
          <div class="service-tools">API · Webhooks · GTM · Apps Script · GitHub</div>
        </div>

        <div class="service-card">
          <div class="service-number">03 — Data</div>
          ...
          <div class="service-tools">Clay · Apollo · ZoomInfo</div>
        </div>

        <div class="service-card">
          <div class="service-number">04 — AI</div>
          ...
          <div class="service-tools">Clay · LLM workflows · AI agents</div>
        </div>

        <div class="service-card">
          <div class="service-number">05 — Funnel</div>
          ...
          <div class="service-tools">HubSpot workflows · scoring frameworks</div>
        </div>

        <div class="service-card">
          <div class="service-number">06 — Email</div>
        ...
        <div class="service-card">
          <div class="service-number">07 — Reporting</div>
          ...
          <div class="service-tools">Google Ads · Meta · LinkedIn · StackAdapt · GA4 · GTM · Looker Studio</div>
        </div>
  ...
  <section class="dark-section fade-in">
    <div class="section-inner">
      ...
      <h2 class="section-title" style="color:var(--cream)">The discipline behind systems that last.</h2>
      <p class="section-body">These run through every engagement — the operational layer that makes the build sustainable after the consultant leaves.</p>

      <div class="detail-grid">
        <div class="detail-card">
          <div class="detail-label">Documentation</div>
          <h4>System Documentation &amp; Operating Models</h4>
          <p>Naming conventions, SOPs, QA checklists, and architecture documentation that let your team continue running the system without me.</p>
        </div>
        <div class="detail-card">
        ...
        <div class="detail-card">
          <div class="detail-label">Enablement</div>
          <h4>Team Training &amp; Stakeholder Coaching</h4>
          <p>Hands-on training for your team on HubSpot operations and best practices. Coaching for stakeholders on what to expect and what to ask for.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="section-inner">
      ...
      <div class="process-grid">
        <div class="process-step">
          ...
          <h3>Audit &amp; Scope</h3>
          <p>We assess the current stack: what's working, what's broken, what's missing. No 40-page deck — just a clear picture of the infrastructure gaps and a plan to close them.</p>
        </div>
        <div class="process-step">
          <div class="process-num">02</div>
          <h3>Build &amp; Configure</h3>
          <p>Hands-on implementation. CRM rebuilds from scratch, custom API/webhook/Apps Script integrations, data architecture, lifecycle and scoring models, campaign infrastructure, reporting — built to your business.</p>
        </div>
        <div class="process-step">
          <div class="process-num">03</div>
          <h3>Run &amp; Optimize</h3>
          <p>Ongoing operations, monitoring, and iteration. Deliverability management, data hygiene, campaign QA, reporting, and the vendor management that keeps the stack healthy long after the build is done.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="section-inner">
      ...
      <div class="exp-entry">
        ...
        <ul class="exp-highlights">
          ...
          <li>Acoustic</li><li>GA4</li><li>Looker Studio</li>
        </ul>
      </div>
      ...
      <div class="exp-entry">
        ...
        <p class="exp-desc">Led digital marketing operations, data infrastructure, and analytics for a high-volume D2C insurance brand. Managed a direct report and external vendor partnerships across email, paid media, display, and social. Ran a 100K+ contact database in Acoustic with Salesforce data feeds via SFTP. Executed multi-channel remarketing campaigns targeting cancelled policyholders — 2 to 5 concurrent campaigns with email volumes exceeding 100K sends per month. Built GA4 from scratch and centralized cross-channel reporting in Looker Studio.</p>
    ...
    <div class="section-inner">
      ...
      <div class="about-layout">
        <div class="about-text">
          <p>Lemnos Consulting is run by Pete Delago — a marketing technology specialist who's spent 8+ years walking into fragmented or nonexistent martech stacks and standing them up from zero. Deep HubSpot, custom API/webhook/Apps Script integrations, data architecture, AI-powered workflows, and the lifecycle systems that feed pipeline.</p>
      ...
      <div class="contact-grid">
        ...
        <div class="dual-cta">
          <div class="cta-block">
            ...
            <h3>Need martech built from scratch?</h3>
            <p>Fractional marketing ops for SMBs with fragmented or nonexistent stacks. CRM rebuilds, custom integrations, data architecture, AI workflows — built to your business and operated day-to-day.</p>
          </div>
          <div class="cta-block">
